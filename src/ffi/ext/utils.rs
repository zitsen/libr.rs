...
fn test_revsort() {
    unsafe {
        ...
        let mut arg2 = [1, 2, 3];
        revsort(::std::ptr::null_mut::<::libc::c_double>(),
...
extern {
    ...
    pub fn rsort_with_index(arg1: *mut ::libc::c_double,
                            arg2: *mut ::libc::c_int,
                            arg3: ::libc::c_int)
                            -> ();
    pub fn Rf_revsort(arg1: *mut ::libc::c_double,
                      arg2: *mut ::libc::c_int,
                      arg3: ::libc::c_int)
                      -> ();
    ...
    pub fn R_qsort_I(v: *mut ::libc::c_double,
                     II: *mut ::libc::c_int,
                     i: ::libc::c_int,
                     j: ::libc::c_int)
                     -> ();
    pub fn R_qsort_int(iv: *mut ::libc::c_int, i: size_t, j: size_t) -> ();
    pub fn R_qsort_int_I(iv: *mut ::libc::c_int,
                         II: *mut ::libc::c_int,
                         i: ::libc::c_int,
                         j: ::libc::c_int)
                         -> ();
    ...
    pub fn Rf_setRVector(arg1: *mut ::libc::c_double,
                         arg2: ::libc::c_int,
                         arg3: ::libc::c_double)
                         -> ();
    ...
    pub fn R_tmpnam(prefix: *const ::libc::c_char,
                    tempdir: *const ::libc::c_char)
                    -> *mut ::libc::c_char;
    pub fn R_tmpnam2(prefix: *const ::libc::c_char,
                     tempdir: *const ::libc::c_char,
    ...
    pub fn findInterval(xt: *mut ::libc::c_double,
                        ...
                        -> ::libc::c_int;
    pub fn find_interv_vec(xt: *mut ::libc::c_double,
                           n: *mut ::libc::c_int,
                           x: *mut ::libc::c_double,
                           nx: *mut ::libc::c_int,
                           ...
                           indx: *mut ::libc::c_int)
                           -> ();
    pub fn R_max_col(matrix: *mut ::libc::c_double,
                     nr: *mut ::libc::c_int,
                     nc: *mut ::libc::c_int,
